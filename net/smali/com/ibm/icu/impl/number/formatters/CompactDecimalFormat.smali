...
.field protected static final threadLocalDataCache:Ljava/lang/ThreadLocal;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/ThreadLocal<Ljava/util/Map<Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;>;>;"
        }
    .end annotation
.end field
...
.method private constructor <init>(Lcom/ibm/icu/text/DecimalFormatSymbols;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$IProperties;)V
    ...
    .line 180
    new-instance v1, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;

    invoke-direct {v1, p1, p2}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;-><init>(Lcom/ibm/icu/text/DecimalFormatSymbols;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$IProperties;)V
    ...
    iput-object v0, p0, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat;->rounder:Lcom/ibm/icu/impl/number/Rounder;

    .line 182
    invoke-static {p1, v1}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat;->getData(Lcom/ibm/icu/text/DecimalFormatSymbols;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;)Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;

    move-result-object v0

    iput-object v0, p0, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat;->data:Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;

    .line 183
    invoke-static {p1, v1}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat;->getDefaultMod(Lcom/ibm/icu/text/DecimalFormatSymbols;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;)Lcom/ibm/icu/impl/number/Modifier$PositiveNegativeModifier;
...
.method private static apply(Lcom/ibm/icu/impl/number/FormatQuantity;Lcom/ibm/icu/impl/number/ModifierHolder;Lcom/ibm/icu/text/PluralRules;Lcom/ibm/icu/impl/number/Rounder;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;Lcom/ibm/icu/impl/number/Modifier$PositiveNegativeModifier;)V
    ...
    .line 230
    invoke-virtual {p4, v1, v2, v3}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;->getModifier(ILcom/ibm/icu/impl/StandardPlural;Z)Lcom/ibm/icu/impl/number/Modifier;
    ...
    .line 233
    invoke-interface {p5, v3}, Lcom/ibm/icu/impl/number/Modifier$PositiveNegativeModifier;->getModifier(Z)Lcom/ibm/icu/impl/number/Modifier;

    move-result-object v4

    .line 235
    :cond_1
    invoke-virtual {p1, v4}, Lcom/ibm/icu/impl/number/ModifierHolder;->add(Lcom/ibm/icu/impl/number/Modifier;)V
...
.method private static getData(Lcom/ibm/icu/text/DecimalFormatSymbols;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;)Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;
    ...
    check-cast v2, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;
    ...
    .line 130
    :cond_0
    new-instance v2, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;

    invoke-direct {v2}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;-><init>()V
    ...
    .line 132
    new-instance v4, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalDataSink;

    invoke-direct {v4, v2, p0, p1}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalDataSink;-><init>(Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;Lcom/ibm/icu/text/DecimalFormatSymbols;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;)V

    .line 133
    invoke-static {v3}, Lcom/ibm/icu/text/NumberingSystem;->getInstance(Lcom/ibm/icu/util/ULocale;)Lcom/ibm/icu/text/NumberingSystem;
    ...
    .line 136
    invoke-static {v5, v6, v4, v2}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat;->internalPopulateData(Ljava/lang/String;Lcom/ibm/icu/impl/ICUResourceBundle;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalDataSink;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;)V

    .line 137
    invoke-virtual {v2}, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;->isEmpty()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p1, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;->compactStyle:Lcom/ibm/icu/text/CompactDecimalFormat$CompactStyle;
    ...
    .line 139
    sget-object v0, Lcom/ibm/icu/text/CompactDecimalFormat$CompactStyle;->SHORT:Lcom/ibm/icu/text/CompactDecimalFormat$CompactStyle;

    iput-object v0, v4, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalDataSink;->compactStyle:Lcom/ibm/icu/text/CompactDecimalFormat$CompactStyle;
...
.method private static getDefaultMod(Lcom/ibm/icu/text/DecimalFormatSymbols;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;)Lcom/ibm/icu/impl/number/Modifier$PositiveNegativeModifier;
    ...
    .line 165
    iget-object v0, p1, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;->compactType:Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactType;
    ...
    invoke-static {v3, v0}, Lcom/ibm/icu/text/NumberFormat;->getPatternForStyle(Lcom/ibm/icu/util/ULocale;I)Ljava/lang/String;
    ...
    .line 172
    :goto_0
    invoke-static {v4}, Lcom/ibm/icu/impl/number/PatternString;->parseToProperties(Ljava/lang/String;)Lcom/ibm/icu/impl/number/Properties;
    ...
    .line 174
    iget-object v0, p1, Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalFingerprint;->currencySymbol:Ljava/lang/String;

    .line 175
    invoke-virtual {v6, p0, v0, v5}, Lcom/ibm/icu/impl/number/PNAffixGenerator;->getModifiers(Lcom/ibm/icu/text/DecimalFormatSymbols;Ljava/lang/String;Lcom/ibm/icu/impl/number/formatters/PositiveNegativeAffixFormat$IProperties;)Lcom/ibm/icu/impl/number/PNAffixGenerator$Result;
    ...
    iget-object v1, v7, Lcom/ibm/icu/impl/number/PNAffixGenerator$Result;->positive:Lcom/ibm/icu/impl/number/Modifier$AffixModifier;

    iget-object v2, v7, Lcom/ibm/icu/impl/number/PNAffixGenerator$Result;->negative:Lcom/ibm/icu/impl/number/Modifier$AffixModifier;
...
.method private static getRounder(Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$IProperties;)Lcom/ibm/icu/impl/number/Rounder;
    ...
    :goto_0
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setMinimumSignificantDigits(I)Lcom/ibm/icu/impl/number/Properties;
    ...
    :goto_1
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setMaximumSignificantDigits(I)Lcom/ibm/icu/impl/number/Properties;
    ...
    :goto_2
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setSignificantDigitsMode(Lcom/ibm/icu/text/DecimalFormat$SignificantDigitsMode;)Lcom/ibm/icu/impl/number/Properties;
    ...
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setRoundingMode(Ljava/math/RoundingMode;)Lcom/ibm/icu/impl/number/Properties;
    ...
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setMinimumFractionDigits(I)Lcom/ibm/icu/impl/number/Properties;
    ...
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setMaximumFractionDigits(I)Lcom/ibm/icu/impl/number/Properties;
    ...
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setMinimumIntegerDigits(I)Lcom/ibm/icu/impl/number/Properties;
    ...
    invoke-virtual {v5, v0}, Lcom/ibm/icu/impl/number/Properties;->setMaximumIntegerDigits(I)Lcom/ibm/icu/impl/number/Properties;

    .line 109
    invoke-static {v5}, Lcom/ibm/icu/impl/number/rounders/SignificantDigitsRounder;->getInstance(Lcom/ibm/icu/impl/number/rounders/SignificantDigitsRounder$IProperties;)Lcom/ibm/icu/impl/number/rounders/SignificantDigitsRounder;
...
.method private static internalPopulateData(Ljava/lang/String;Lcom/ibm/icu/impl/ICUResourceBundle;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalDataSink;Lcom/ibm/icu/impl/number/formatters/CompactDecimalFormat$CompactDecimalData;)V
    ...
    .line 154
    const-string v0, "NumberElements/latn"
