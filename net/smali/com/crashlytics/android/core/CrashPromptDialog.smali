...
.method public static create(Landroid/app/Activity;Lo/SQ;Lcom/crashlytics/android/core/CrashPromptDialog$AlwaysSendCallback;)Lcom/crashlytics/android/core/CrashPromptDialog;
    .locals 8

    .line 50
    new-instance v2, Lcom/crashlytics/android/core/CrashPromptDialog$OptInLatch;

    const/4 v0, 0x0

    invoke-direct {v2, v0}, Lcom/crashlytics/android/core/CrashPromptDialog$OptInLatch;-><init>(Lcom/crashlytics/android/core/CrashPromptDialog$1;)V

    .line 51
    new-instance v3, Lcom/crashlytics/android/core/DialogStringResolver;

    invoke-direct {v3, p0, p1}, Lcom/crashlytics/android/core/DialogStringResolver;-><init>(Landroid/content/Context;Lo/SQ;)V
    ...
    .line 54
    invoke-virtual {v3}, Lcom/crashlytics/android/core/DialogStringResolver;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, v0}, Lcom/crashlytics/android/core/CrashPromptDialog;->createDialogView(Landroid/app/Activity;Ljava/lang/String;)Landroid/widget/ScrollView;

    move-result-object v5

    .line 56
    new-instance v6, Lcom/crashlytics/android/core/CrashPromptDialog$1;

    invoke-direct {v6, v2}, Lcom/crashlytics/android/core/CrashPromptDialog$1;-><init>(Lcom/crashlytics/android/core/CrashPromptDialog$OptInLatch;)V
    ...
    invoke-direct {v7, v2}, Lcom/crashlytics/android/core/CrashPromptDialog$2;-><init>(Lcom/crashlytics/android/core/CrashPromptDialog$OptInLatch;)V

    .line 81
    invoke-virtual {v3}, Lcom/crashlytics/android/core/DialogStringResolver;->getCancelButtonTitle()Ljava/lang/String;
    ...
    .line 85
    :cond_0
    iget-boolean v0, p1, Lo/SQ;->ʽ:Z

    if-eqz v0, :cond_1

    .line 86
    new-instance v7, Lcom/crashlytics/android/core/CrashPromptDialog$3;

    invoke-direct {v7, p2, v2}, Lcom/crashlytics/android/core/CrashPromptDialog$3;-><init>(Lcom/crashlytics/android/core/CrashPromptDialog$AlwaysSendCallback;Lcom/crashlytics/android/core/CrashPromptDialog$OptInLatch;)V

    .line 95
    invoke-virtual {v3}, Lcom/crashlytics/android/core/DialogStringResolver;->getAlwaysSendButtonTitle()Ljava/lang/String;
    ...
    .line 99
    :cond_1
    new-instance v0, Lcom/crashlytics/android/core/CrashPromptDialog;

    invoke-direct {v0, v4, v2}, Lcom/crashlytics/android/core/CrashPromptDialog;-><init>(Landroid/app/AlertDialog$Builder;Lcom/crashlytics/android/core/CrashPromptDialog$OptInLatch;)V
...
.method private static createDialogView(Landroid/app/Activity;Ljava/lang/String;)Landroid/widget/ScrollView;
    ...
    invoke-static {v4, v0}, Lcom/crashlytics/android/core/CrashPromptDialog;->dipsToPixels(FI)I
    ...
    invoke-static {v4, v1}, Lcom/crashlytics/android/core/CrashPromptDialog;->dipsToPixels(FI)I
    ...
    invoke-static {v4, v2}, Lcom/crashlytics/android/core/CrashPromptDialog;->dipsToPixels(FI)I

    move-result v2

    const/16 v3, 0xc

    invoke-static {v4, v3}, Lcom/crashlytics/android/core/CrashPromptDialog;->dipsToPixels(FI)I
