...
.field private final zada:Landroid/support/v4/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/util/ArrayMap<Lcom/google/android/gms/common/api/internal/zai<*>;Ljava/lang/String;>;"
        }
    .end annotation
.end field
...
.field private final zadb:Lcom/google/android/gms/tasks/TaskCompletionSource;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/android/gms/tasks/TaskCompletionSource<Ljava/util/Map<Lcom/google/android/gms/common/api/internal/zai<*>;Ljava/lang/String;>;>;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/lang/Iterable<+Lcom/google/android/gms/common/api/GoogleApi<*>;>;)V"
        }
    .end annotation
...
.method public final getTask()Lcom/google/android/gms/tasks/Task;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()Lcom/google/android/gms/tasks/Task<Ljava/util/Map<Lcom/google/android/gms/common/api/internal/zai<*>;Ljava/lang/String;>;>;"
        }
    .end annotation
...
.method public final zaa(Lcom/google/android/gms/common/api/internal/zai;Lcom/google/android/gms/common/ConnectionResult;Ljava/lang/String;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lcom/google/android/gms/common/api/internal/zai<*>;Lcom/google/android/gms/common/ConnectionResult;Ljava/lang/String;)V"
        }
    .end annotation
    ...
    invoke-direct {v2, v0}, Lcom/google/android/gms/common/api/AvailabilityException;-><init>(Landroid/support/v4/util/ArrayMap;)V
