...
.field private static sRunningAnimators:Ljava/lang/ThreadLocal;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/ThreadLocal<Landroid/support/v4/util/ArrayMap<Landroid/animation/Animator;Landroid/support/transition/Transition$AnimationInfo;>;>;"
        }
    .end annotation
.end field
...
.field private mEndValuesList:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<Landroid/support/transition/TransitionValues;>;"
        }
    .end annotation
.end field
...
.field private mListeners:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<Landroid/support/transition/Transition$TransitionListener;>;"
        }
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/support/transition/Transition;->mCanRemoveViews:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {v3, v4, v0, v1, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedInt(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    .line 285
    invoke-virtual {p0, v7, v8}, Landroid/support/transition/Transition;->setStartDelay(J)Landroid/support/transition/Transition;
    ...
    invoke-static {v3, v4, v0, v1, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedResourceId(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    invoke-virtual {p0, v0}, Landroid/support/transition/Transition;->setInterpolator(Landroid/animation/TimeInterpolator;)Landroid/support/transition/Transition;
    ...
    invoke-static {v3, v4, v0, v1}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedString(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 295
    invoke-static {v10}, Landroid/support/transition/Transition;->parseMatchOrder(Ljava/lang/String;)[I

    move-result-object v0

    invoke-virtual {p0, v0}, Landroid/support/transition/Transition;->setMatchOrder([I)V
...
.method private addUnmatched(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;)V"
        }
    .end annotation
    ...
    .line 646
    iget-object v0, v3, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
...
.method private static addViewValues(Landroid/support/transition/TransitionValuesMaps;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
    ...
    .line 1534
    iget-object v0, p0, Landroid/support/transition/TransitionValuesMaps;->mIdValues:Landroid/util/SparseArray;
    ...
    .line 1543
    iget-object v0, p0, Landroid/support/transition/TransitionValuesMaps;->mNameValues:Landroid/support/v4/util/ArrayMap;
    ...
    invoke-virtual {v0, v3, p1}, Landroid/support/v4/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6, v7}, Landroid/support/v4/util/LongSparseArray;->indexOfKey(J)I
    ...
    invoke-static {v8, v0}, Landroid/support/v4/view/ViewCompat;->setHasTransientState(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, v6, v7, p1}, Landroid/support/v4/util/LongSparseArray;->put(JLjava/lang/Object;)V
...
.method private captureHierarchy(Landroid/view/View;Z)V
    ...
    .line 1618
    iput-object p1, v3, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
    ...
    .line 1624
    :goto_1
    iget-object v0, v3, Landroid/support/transition/TransitionValues;->mTargetedTransitions:Ljava/util/ArrayList;
    ...
    invoke-static {v0, p1, v3}, Landroid/support/transition/Transition;->addViewValues(Landroid/support/transition/TransitionValuesMaps;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
...
.method private static getRunningAnimators()Landroid/support/v4/util/ArrayMap;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()Landroid/support/v4/util/ArrayMap<Landroid/animation/Animator;Landroid/support/transition/Transition$AnimationInfo;>;"
        }
    .end annotation
...
.method private matchIds(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;Landroid/util/SparseArray<Landroid/view/View;>;Landroid/util/SparseArray<Landroid/view/View;>;)V"
        }
    .end annotation
    ...
    .line 602
    invoke-virtual {p1, v3}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 603
    invoke-virtual {p2, v4}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private matchInstances(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    iget-object v0, v4, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
...
.method private matchItemIds(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/LongSparseArray;Landroid/support/v4/util/LongSparseArray;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;Landroid/support/v4/util/LongSparseArray<Landroid/view/View;>;Landroid/support/v4/util/LongSparseArray<Landroid/view/View;>;)V"
        }
    .end annotation
    ...
    .line 566
    invoke-virtual {p3, v3}, Landroid/support/v4/util/LongSparseArray;->valueAt(I)Ljava/lang/Object;
    ...
    .line 568
    invoke-virtual {p3, v3}, Landroid/support/v4/util/LongSparseArray;->keyAt(I)J
    ...
    .line 570
    invoke-virtual {p1, v4}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 571
    invoke-virtual {p2, v5}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 575
    invoke-virtual {p1, v4}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 576
    invoke-virtual {p2, v5}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private matchNames(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;Landroid/support/v4/util/ArrayMap<Landroid/view/View;Landroid/support/transition/TransitionValues;>;Landroid/support/v4/util/ArrayMap<Ljava/lang/String;Landroid/view/View;>;Landroid/support/v4/util/ArrayMap<Ljava/lang/String;Landroid/view/View;>;)V"
        }
    .end annotation
    ...
    invoke-virtual {p4, v0}, Landroid/support/v4/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private matchStartAndEnd(Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;)V
    ...
    invoke-direct {v3, v0}, Landroid/support/v4/util/ArrayMap;-><init>(Landroid/support/v4/util/SimpleArrayMap;)V

    .line 667
    const/4 v4, 0x0

    :goto_0
    iget-object v0, p0, Landroid/support/transition/Transition;->mMatchOrder:[I
    ...
    .line 670
    :pswitch_0
    invoke-direct {p0, v2, v3}, Landroid/support/transition/Transition;->matchInstances(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    .line 673
    :pswitch_1
    iget-object v0, p1, Landroid/support/transition/TransitionValuesMaps;->mNameValues:Landroid/support/v4/util/ArrayMap;

    iget-object v1, p2, Landroid/support/transition/TransitionValuesMaps;->mNameValues:Landroid/support/v4/util/ArrayMap;

    invoke-direct {p0, v2, v3, v0, v1}, Landroid/support/transition/Transition;->matchNames(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
    ...
    .line 677
    :pswitch_2
    iget-object v0, p1, Landroid/support/transition/TransitionValuesMaps;->mIdValues:Landroid/util/SparseArray;

    iget-object v1, p2, Landroid/support/transition/TransitionValuesMaps;->mIdValues:Landroid/util/SparseArray;

    invoke-direct {p0, v2, v3, v0, v1}, Landroid/support/transition/Transition;->matchIds(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    .line 681
    :pswitch_3
    iget-object v0, p1, Landroid/support/transition/TransitionValuesMaps;->mItemIdValues:Landroid/support/v4/util/LongSparseArray;

    iget-object v1, p2, Landroid/support/transition/TransitionValuesMaps;->mItemIdValues:Landroid/support/v4/util/LongSparseArray;

    invoke-direct {p0, v2, v3, v0, v1}, Landroid/support/transition/Transition;->matchItemIds(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/LongSparseArray;Landroid/support/v4/util/LongSparseArray;)V
    ...
    .line 686
    :cond_0
    invoke-direct {p0, v2, v3}, Landroid/support/transition/Transition;->addUnmatched(Landroid/support/v4/util/ArrayMap;Landroid/support/v4/util/ArrayMap;)V
...
.method private runAnimator(Landroid/animation/Animator;Landroid/support/v4/util/ArrayMap;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/animation/Animator;Landroid/support/v4/util/ArrayMap<Landroid/animation/Animator;Landroid/support/transition/Transition$AnimationInfo;>;)V"
        }
    .end annotation
...
.method captureValues(Landroid/view/ViewGroup;Z)V
    ...
    .line 1483
    :goto_1
    iget-object v0, v4, Landroid/support/transition/TransitionValues;->mTargetedTransitions:Ljava/util/ArrayList;
    ...
    invoke-static {v0, v3, v4}, Landroid/support/transition/Transition;->addViewValues(Landroid/support/transition/TransitionValuesMaps;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
    ...
    invoke-static {v0, v2, v3}, Landroid/support/transition/Transition;->addViewValues(Landroid/support/transition/TransitionValuesMaps;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
    ...
    iget-object v0, v0, Landroid/support/transition/TransitionValuesMaps;->mNameValues:Landroid/support/v4/util/ArrayMap;
...
.method public clone()Landroid/support/transition/Transition;
    ...
    iput-object v0, v1, Landroid/support/transition/Transition;->mAnimators:Ljava/util/ArrayList;
    ...
    iput-object v0, v1, Landroid/support/transition/Transition;->mStartValues:Landroid/support/transition/TransitionValuesMaps;
    ...
    iput-object v0, v1, Landroid/support/transition/Transition;->mEndValues:Landroid/support/transition/TransitionValuesMaps;
...
.method protected createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-object v0, v12, Landroid/support/transition/TransitionValues;->mTargetedTransitions:Ljava/util/ArrayList;
    ...
    iget-object v0, v13, Landroid/support/transition/TransitionValues;->mTargetedTransitions:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v12, v13}, Landroid/support/transition/Transition;->isTransitionRequired(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Z
    ...
    invoke-virtual {v0, v1, v12, v13}, Landroid/support/transition/Transition;->createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 750
    iget-object v0, v13, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
    ...
    .line 753
    new-instance v17, Landroid/support/transition/TransitionValues;

    invoke-direct/range {v17 .. v17}, Landroid/support/transition/TransitionValues;-><init>()V
    ...
    invoke-virtual {v6, v0}, Landroid/support/v4/util/ArrayMap;->keyAt(I)Ljava/lang/Object;
    ...
    check-cast v23, Landroid/support/transition/Transition$AnimationInfo;

    .line 766
    move-object/from16 v0, v23

    iget-object v0, v0, Landroid/support/transition/Transition$AnimationInfo;->mValues:Landroid/support/transition/TransitionValues;

    if-eqz v0, :cond_6

    move-object/from16 v0, v23

    iget-object v0, v0, Landroid/support/transition/Transition$AnimationInfo;->mView:Landroid/view/View;
    ...
    iget-object v0, v0, Landroid/support/transition/Transition$AnimationInfo;->mName:Ljava/lang/String;
    ...
    .line 777
    :cond_8
    iget-object v0, v12, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
    ...
    iget-object v0, v0, Landroid/support/transition/Transition;->mPropagation:Landroid/support/transition/TransitionPropagation;
    ...
    invoke-virtual {v0, v1, v2, v12, v13}, Landroid/support/transition/TransitionPropagation;->getStartDelay(Landroid/view/ViewGroup;Landroid/support/transition/Transition;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)J
    ...
    iget-object v0, v0, Landroid/support/transition/Transition;->mAnimators:Ljava/util/ArrayList;
    ...
    .line 785
    :cond_9
    new-instance v0, Landroid/support/transition/Transition$AnimationInfo;
    ...
    invoke-virtual {v6, v15, v0}, Landroid/support/v4/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected end()V
    ...
    invoke-interface {v0, p0}, Landroid/support/transition/Transition$TransitionListener;->onTransitionEnd(Landroid/support/transition/Transition;)V
    ...
    invoke-static {v3, v0}, Landroid/support/v4/view/ViewCompat;->setHasTransientState(Landroid/view/View;Z)V
...
.method getMatchedTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    ...
    iget-object v1, p0, Landroid/support/transition/Transition;->mStartValuesList:Ljava/util/ArrayList;
    ...
    .line 1696
    :cond_3
    iget-object v0, v5, Landroid/support/transition/TransitionValues;->view:Landroid/view/View;
    ...
    :cond_6
    iget-object v5, p0, Landroid/support/transition/Transition;->mStartValuesList:Ljava/util/ArrayList;
...
.method public getTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    ...
    iget-object v1, p0, Landroid/support/transition/Transition;->mStartValues:Landroid/support/transition/TransitionValuesMaps;
    ...
    .line 1667
    :goto_0
    iget-object v0, v1, Landroid/support/transition/TransitionValuesMaps;->mViewValues:Landroid/support/v4/util/ArrayMap;
...
.method public isTransitionRequired(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Z
    ...
    .line 1843
    invoke-static {p1, p2, v6}, Landroid/support/transition/Transition;->isValueChanged(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;Ljava/lang/String;)Z
...
.method public pause(Landroid/view/View;)V
    ...
    .line 1724
    iget-object v0, v5, Landroid/support/transition/Transition$AnimationInfo;->mView:Landroid/view/View;

    if-eqz v0, :cond_0

    iget-object v0, v5, Landroid/support/transition/Transition$AnimationInfo;->mWindowId:Landroid/support/transition/WindowIdImpl;
    ...
    .line 1726
    invoke-static {v6}, Landroid/support/transition/AnimatorUtils;->pause(Landroid/animation/Animator;)V
    ...
    invoke-interface {v0, p0}, Landroid/support/transition/Transition$TransitionListener;->onTransitionPause(Landroid/support/transition/Transition;)V
...
.method playTransition(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, v0, Landroid/support/transition/Transition;->mStartValues:Landroid/support/transition/TransitionValuesMaps;

    move-object/from16 v1, p0

    iget-object v1, v1, Landroid/support/transition/Transition;->mEndValues:Landroid/support/transition/TransitionValuesMaps;

    move-object/from16 v2, p0

    invoke-direct {v2, v0, v1}, Landroid/support/transition/Transition;->matchStartAndEnd(Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;)V
    ...
    .line 1789
    invoke-virtual {v6, v9}, Landroid/support/v4/util/ArrayMap;->keyAt(I)Ljava/lang/Object;
    ...
    check-cast v11, Landroid/support/transition/Transition$AnimationInfo;

    .line 1792
    if-eqz v11, :cond_4

    iget-object v0, v11, Landroid/support/transition/Transition$AnimationInfo;->mView:Landroid/view/View;

    if-eqz v0, :cond_4

    iget-object v0, v11, Landroid/support/transition/Transition$AnimationInfo;->mWindowId:Landroid/support/transition/WindowIdImpl;
    ...
    .line 1794
    iget-object v12, v11, Landroid/support/transition/Transition$AnimationInfo;->mValues:Landroid/support/transition/TransitionValues;

    .line 1795
    iget-object v13, v11, Landroid/support/transition/Transition$AnimationInfo;->mView:Landroid/view/View;
    ...
    invoke-virtual {v0, v13, v1}, Landroid/support/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    ...
    invoke-virtual {v0, v13, v1}, Landroid/support/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    ...
    :cond_0
    iget-object v0, v11, Landroid/support/transition/Transition$AnimationInfo;->mTransition:Landroid/support/transition/Transition;

    .line 1799
    invoke-virtual {v0, v12, v15}, Landroid/support/transition/Transition;->isTransitionRequired(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Z
    ...
    .line 1810
    :cond_3
    invoke-virtual {v6, v10}, Landroid/support/v4/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, v2, Landroid/support/transition/Transition;->mStartValues:Landroid/support/transition/TransitionValuesMaps;

    move-object/from16 v3, p0

    iget-object v3, v3, Landroid/support/transition/Transition;->mEndValues:Landroid/support/transition/TransitionValuesMaps;

    move-object/from16 v4, p0

    iget-object v4, v4, Landroid/support/transition/Transition;->mStartValuesList:Ljava/util/ArrayList;

    move-object/from16 v5, p0

    iget-object v5, v5, Landroid/support/transition/Transition;->mEndValuesList:Ljava/util/ArrayList;
...
.method public resume(Landroid/view/View;)V
    ...
    invoke-interface {v0, p0}, Landroid/support/transition/Transition$TransitionListener;->onTransitionResume(Landroid/support/transition/Transition;)V
...
.method protected runAnimators()V
    ...
    .line 885
    invoke-direct {p0, v3, v1}, Landroid/support/transition/Transition;->runAnimator(Landroid/animation/Animator;Landroid/support/v4/util/ArrayMap;)V
...
.method public varargs setMatchOrder([I)V
    ...
    .line 512
    invoke-static {v3}, Landroid/support/transition/Transition;->isValidMatch(I)Z
    ...
    .line 515
    :cond_2
    invoke-static {p1, v2}, Landroid/support/transition/Transition;->alreadyContains([II)Z
...
.method protected start()V
    ...
    invoke-interface {v0, p0}, Landroid/support/transition/Transition$TransitionListener;->onTransitionStart(Landroid/support/transition/Transition;)V
