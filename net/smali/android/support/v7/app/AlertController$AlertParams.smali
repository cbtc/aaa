...
.method private createListView(Landroid/support/v7/app/AlertController;)V
    ...
    check-cast v7, Landroid/support/v7/app/AlertController$RecycleListView;
    ...
    .line 1039
    iget v9, p1, Landroid/support/v7/app/AlertController;->mSingleChoiceItemLayout:I

    goto :goto_0

    .line 1041
    :cond_2
    iget v9, p1, Landroid/support/v7/app/AlertController;->mListItemLayout:I
    ...
    iget-object v5, p0, Landroid/support/v7/app/AlertController$AlertParams;->mLabelColumn:Ljava/lang/String;
    ...
    .line 1048
    iget-object v8, p0, Landroid/support/v7/app/AlertController$AlertParams;->mAdapter:Landroid/widget/ListAdapter;

    goto :goto_1

    .line 1050
    :cond_4
    new-instance v8, Landroid/support/v7/app/AlertController$CheckedItemAdapter;

    iget-object v0, p0, Landroid/support/v7/app/AlertController$AlertParams;->mContext:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v7/app/AlertController$AlertParams;->mItems:[Ljava/lang/CharSequence;

    const v2, 0x1020014

    invoke-direct {v8, v0, v9, v2, v1}, Landroid/support/v7/app/AlertController$CheckedItemAdapter;-><init>(Landroid/content/Context;II[Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, v7}, Landroid/support/v7/app/AlertController$AlertParams$OnPrepareListViewListener;->onPrepareListView(Landroid/widget/ListView;)V

    .line 1061
    :cond_5
    iput-object v8, p1, Landroid/support/v7/app/AlertController;->mAdapter:Landroid/widget/ListAdapter;
    ...
    invoke-virtual {v7, v0}, Landroid/support/v7/app/AlertController$RecycleListView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-direct {v0, p0, v7, p1}, Landroid/support/v7/app/AlertController$AlertParams$4;-><init>(Landroid/support/v7/app/AlertController$AlertParams;Landroid/support/v7/app/AlertController$RecycleListView;Landroid/support/v7/app/AlertController;)V
    ...
    invoke-virtual {v7, v0}, Landroid/support/v7/app/AlertController$RecycleListView;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v7, v0}, Landroid/support/v7/app/AlertController$RecycleListView;->setChoiceMode(I)V
    ...
    :cond_a
    :goto_3
    iput-object v7, p1, Landroid/support/v7/app/AlertController;->mListView:Landroid/widget/ListView;
