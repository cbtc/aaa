...
.method private applyInsets(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    iget v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->leftMargin:I
    ...
    iput v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->leftMargin:I

    .line 270
    :cond_0
    if-eqz p4, :cond_1

    iget v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->topMargin:I
    ...
    iput v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->topMargin:I

    .line 274
    :cond_1
    if-eqz p6, :cond_2

    iget v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->rightMargin:I
    ...
    iput v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->rightMargin:I

    .line 278
    :cond_2
    if-eqz p5, :cond_3

    iget v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->bottomMargin:I
    ...
    iput v0, v3, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->bottomMargin:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 434
    invoke-virtual {p0, v7}, Landroid/support/v7/widget/ActionBarOverlayLayout;->getChildAt(I)Landroid/view/View;
    ...
    .line 441
    iget v0, v9, Landroid/support/v7/widget/ActionBarOverlayLayout$LayoutParams;->leftMargin:I
...
.method protected onMeasure(II)V
    ...
    iget v10, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->mActionBarHeight:I
    ...
    iget-object v1, v1, Landroid/support/v7/widget/ActionBarOverlayLayout;->mBaseContentInsets:Landroid/graphics/Rect;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroid/graphics/Rect;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/ActionBarOverlayLayout;->mContentInsets:Landroid/graphics/Rect;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/ActionBarOverlayLayout;->mInnerInsets:Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, v0, v1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->setMeasuredDimension(II)V
...
.method public setActionBarVisibilityCallback(Landroid/support/v7/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;)V
    ...
    .line 174
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/ActionBarOverlayLayout;->onWindowSystemUiVisibilityChanged(I)V
