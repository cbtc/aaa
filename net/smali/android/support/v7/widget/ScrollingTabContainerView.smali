...
.method private createSpinner()Landroid/widget/Spinner;
    ...
    sget v1, Landroid/support/v7/appcompat/R$attr;->actionDropDownStyle:I

    const/4 v2, 0x0

    invoke-direct {v3, v0, v2, v1}, Landroid/support/v7/widget/AppCompatSpinner;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private createTabLayout()Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    .line 204
    new-instance v3, Landroid/support/v7/widget/LinearLayoutCompat;
    ...
    invoke-direct {v3, v0, v2, v1}, Landroid/support/v7/widget/LinearLayoutCompat;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 206
    const/4 v0, 0x1

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/LinearLayoutCompat;->setMeasureWithLargestChildEnabled(Z)V

    .line 207
    const/16 v0, 0x11

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/LinearLayoutCompat;->setGravity(I)V
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/LinearLayoutCompat;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public animateToTab(I)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ScrollingTabContainerView$1;-><init>(Landroid/support/v7/widget/ScrollingTabContainerView;Landroid/view/View;)V
...
.method createTabView(Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/widget/ScrollingTabContainerView$TabView;
    ...
    .line 293
    new-instance v3, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;

    invoke-virtual {p0}, Landroid/support/v7/widget/ScrollingTabContainerView;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {v3, p0, v0, p1, p2}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;-><init>(Landroid/support/v7/widget/ScrollingTabContainerView;Landroid/content/Context;Landroid/support/v7/app/ActionBar$Tab;Z)V
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->setFocusable(Z)V

    .line 301
    iget-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->mTabClickListener:Landroid/support/v7/widget/ScrollingTabContainerView$TabClickListener;

    if-nez v0, :cond_1

    .line 302
    new-instance v0, Landroid/support/v7/widget/ScrollingTabContainerView$TabClickListener;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabClickListener;-><init>(Landroid/support/v7/widget/ScrollingTabContainerView;)V

    iput-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->mTabClickListener:Landroid/support/v7/widget/ScrollingTabContainerView$TabClickListener;

    .line 304
    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->mTabClickListener:Landroid/support/v7/widget/ScrollingTabContainerView$TabClickListener;

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 230
    invoke-virtual {v1}, Landroid/support/v7/view/ActionBarPolicy;->getTabContainerHeight()I
    ...
    .line 231
    invoke-virtual {v1}, Landroid/support/v7/view/ActionBarPolicy;->getStackedTabMaxWidth()I
...
.method public onMeasure(II)V
    ...
    .line 109
    :goto_1
    iget v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->mMaxTabWidth:I
    ...
    .line 114
    :goto_2
    iget v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView;->mContentHeight:I
