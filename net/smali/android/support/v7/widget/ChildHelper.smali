...
.method private getOffset(I)I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ChildHelper$Bucket;->countOnesBefore(I)I
...
.method addView(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, v1, p3}, Landroid/support/v7/widget/ChildHelper$Bucket;->insert(IZ)V
    ...
    invoke-interface {v0, p1, v1}, Landroid/support/v7/widget/ChildHelper$Callback;->addView(Landroid/view/View;I)V
...
.method attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    invoke-virtual {v0, v1, p4}, Landroid/support/v7/widget/ChildHelper$Bucket;->insert(IZ)V
    ...
    invoke-interface {v0, p1, v1, p3}, Landroid/support/v7/widget/ChildHelper$Callback;->attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method detachViewFromParent(I)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ChildHelper$Callback;->detachViewFromParent(I)V
...
.method findHiddenNonRemovedView(I)Landroid/view/View;
    ...
    invoke-interface {v0, v3}, Landroid/support/v7/widget/ChildHelper$Callback;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;
...
.method getChildAt(I)Landroid/view/View;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ChildHelper$Callback;->getChildAt(I)Landroid/view/View;
...
.method hide(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ChildHelper$Bucket;->set(I)V
...
.method removeAllViewsUnfiltered()V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/ChildHelper$Callback;->onLeftHiddenState(Landroid/view/View;)V
...
.method removeViewAt(I)V
    ...
    .line 166
    invoke-direct {p0, v2}, Landroid/support/v7/widget/ChildHelper;->unhideViewInternal(Landroid/view/View;)Z
...
.method unhide(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ChildHelper$Bucket;->get(I)Z
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ChildHelper$Bucket;->clear(I)V
