...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 96
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->alpha:F
    ...
    .line 97
    :cond_0
    sget v0, Landroid/support/constraint/R$styleable;->ConstraintSet_android_elevation:I

    if-ne v4, v0, :cond_1

    .line 98
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->elevation:F
    ...
    .line 101
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->rotationX:F
    ...
    .line 102
    :cond_2
    sget v0, Landroid/support/constraint/R$styleable;->ConstraintSet_android_rotationY:I

    if-ne v4, v0, :cond_3

    .line 103
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->rotationY:F
    ...
    .line 105
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->rotation:F
    ...
    .line 107
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->scaleX:F
    ...
    .line 108
    :cond_5
    sget v0, Landroid/support/constraint/R$styleable;->ConstraintSet_android_scaleY:I

    if-ne v4, v0, :cond_6

    .line 109
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->scaleY:F
    ...
    .line 111
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->transformPivotX:F
    ...
    .line 112
    :cond_7
    sget v0, Landroid/support/constraint/R$styleable;->ConstraintSet_android_transformPivotY:I

    if-ne v4, v0, :cond_8

    .line 113
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->transformPivotY:F
    ...
    .line 114
    :cond_8
    sget v0, Landroid/support/constraint/R$styleable;->ConstraintSet_android_translationX:I

    if-ne v4, v0, :cond_9

    .line 115
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->translationX:F
    ...
    .line 116
    :cond_9
    sget v0, Landroid/support/constraint/R$styleable;->ConstraintSet_android_translationY:I

    if-ne v4, v0, :cond_a

    .line 117
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->translationY:F
    ...
    .line 119
    iget v0, p0, Landroid/support/constraint/Constraints$LayoutParams;->translationZ:F
