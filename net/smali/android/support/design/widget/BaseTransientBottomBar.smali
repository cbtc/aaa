...
.field private callbacks:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<Landroid/support/design/widget/BaseTransientBottomBar$BaseCallback<TB;>;>;"
        }
    .end annotation
.end field
...
.method protected constructor <init>(Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/design/snackbar/ContentViewCallback;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->view:Landroid/support/design/widget/BaseTransientBottomBar$SnackbarBaseLayout;
    ...
    iput-object v0, p0, Landroid/support/design/widget/BaseTransientBottomBar;->accessibilityManager:Landroid/view/accessibility/AccessibilityManager;
...
.method private animateViewOut(I)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/design/widget/BaseTransientBottomBar$10;-><init>(Landroid/support/design/widget/BaseTransientBottomBar;I)V

    invoke-virtual {v3, v0}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 628
    new-instance v0, Landroid/support/design/widget/BaseTransientBottomBar$11;

    invoke-direct {v0, p0}, Landroid/support/design/widget/BaseTransientBottomBar$11;-><init>(Landroid/support/design/widget/BaseTransientBottomBar;)V
...
.method animateViewIn()V
    ...
    invoke-static {v0, v3}, Landroid/support/v4/view/ViewCompat;->offsetTopAndBottom(Landroid/view/View;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/design/widget/BaseTransientBottomBar$8;-><init>(Landroid/support/design/widget/BaseTransientBottomBar;)V

    invoke-virtual {v4, v0}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 590
    new-instance v0, Landroid/support/design/widget/BaseTransientBottomBar$9;

    invoke-direct {v0, p0, v3}, Landroid/support/design/widget/BaseTransientBottomBar$9;-><init>(Landroid/support/design/widget/BaseTransientBottomBar;I)V
...
.method protected getNewBehavior()Landroid/support/design/widget/SwipeDismissBehavior;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()Landroid/support/design/widget/SwipeDismissBehavior<+Landroid/view/View;>;"
        }
    .end annotation
...
.method final showView()V
    ...
    :cond_0
    iget-object v4, p0, Landroid/support/design/widget/BaseTransientBottomBar;->behavior:Landroid/support/design/widget/BaseTransientBottomBar$Behavior;

    .line 478
    :goto_0
    instance-of v0, v4, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;
    ...
    # invokes: Landroid/support/design/widget/BaseTransientBottomBar$Behavior;->setBaseTransientBottomBar(Landroid/support/design/widget/BaseTransientBottomBar;)V
    invoke-static {v0, p0}, Landroid/support/design/widget/BaseTransientBottomBar$Behavior;->access$000(Landroid/support/design/widget/BaseTransientBottomBar$Behavior;Landroid/support/design/widget/BaseTransientBottomBar;)V

    .line 481
    :cond_1
    new-instance v0, Landroid/support/design/widget/BaseTransientBottomBar$5;

    invoke-direct {v0, p0}, Landroid/support/design/widget/BaseTransientBottomBar$5;-><init>(Landroid/support/design/widget/BaseTransientBottomBar;)V

    invoke-virtual {v4, v0}, Landroid/support/design/widget/SwipeDismissBehavior;->setListener(Landroid/support/design/widget/SwipeDismissBehavior$OnDismissListener;)V
