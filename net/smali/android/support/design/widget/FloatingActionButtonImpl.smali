...
.field private hideListeners:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<Landroid/animation/Animator$AnimatorListener;>;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/FloatingActionButtonImpl;->HOVERED_FOCUSED_ENABLED_STATE_SET:[I
...
.method private calculateImageMatrixFromScale(FLandroid/graphics/Matrix;)V
    ...
    .line 295
    iget-object v5, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->tmpRectF1:Landroid/graphics/RectF;

    .line 296
    iget-object v6, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->tmpRectF2:Landroid/graphics/RectF;
    ...
    invoke-virtual {v6, v2, v3, v0, v1}, Landroid/graphics/RectF;->set(FFFF)V
...
.method private createAnimator(Landroid/support/design/animation/MotionSpec;FFF)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p1, v0}, Landroid/support/design/animation/MotionSpec;->getTiming(Ljava/lang/String;)Landroid/support/design/animation/MotionTiming;

    move-result-object v0

    invoke-virtual {v0, v7}, Landroid/support/design/animation/MotionTiming;->apply(Landroid/animation/Animator;)V
    ...
    invoke-direct {p0, p4, v0}, Landroid/support/design/widget/FloatingActionButtonImpl;->calculateImageMatrixFromScale(FLandroid/graphics/Matrix;)V

    .line 531
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->view:Landroid/support/design/widget/VisibilityAwareImageButton;

    new-instance v1, Landroid/support/design/animation/ImageMatrixProperty;

    invoke-direct {v1}, Landroid/support/design/animation/ImageMatrixProperty;-><init>()V

    new-instance v2, Landroid/support/design/animation/MatrixEvaluator;

    invoke-direct {v2}, Landroid/support/design/animation/MatrixEvaluator;-><init>()V
    ...
    iget-object v5, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->tmpMatrix:Landroid/graphics/Matrix;
...
.method createBorderDrawable(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/CircularBorderDrawable;
    ...
    .line 584
    sget v0, Landroid/support/design/R$color;->design_fab_stroke_top_outer_color:I
    ...
    sget v1, Landroid/support/design/R$color;->design_fab_stroke_top_inner_color:I
    ...
    sget v2, Landroid/support/design/R$color;->design_fab_stroke_end_inner_color:I
    ...
    sget v3, Landroid/support/design/R$color;->design_fab_stroke_end_outer_color:I
    ...
    .line 584
    invoke-virtual {v5, v0, v1, v2, v3}, Landroid/support/design/widget/CircularBorderDrawable;->setGradientColors(IIII)V

    .line 589
    int-to-float v0, p1

    invoke-virtual {v5, v0}, Landroid/support/design/widget/CircularBorderDrawable;->setBorderWidth(F)V

    .line 590
    invoke-virtual {v5, p2}, Landroid/support/design/widget/CircularBorderDrawable;->setBorderTint(Landroid/content/res/ColorStateList;)V
...
.method hide(Landroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;Z)V
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Landroid/support/design/widget/FloatingActionButtonImpl;->createAnimator(Landroid/support/design/animation/MotionSpec;FFF)Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v0, p0, p2, p1}, Landroid/support/design/widget/FloatingActionButtonImpl$1;-><init>(Landroid/support/design/widget/FloatingActionButtonImpl;ZLandroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;)V
...
.method onPreDraw()V
    ...
    .line 601
    iput v1, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->rotation:F
...
.method setBackgroundDrawable(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->rippleDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->borderDrawable:Landroid/support/design/widget/CircularBorderDrawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->contentBackground:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->contentBackground:Landroid/graphics/drawable/Drawable;

    iget-object v3, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->shadowViewDelegate:Landroid/support/design/widget/ShadowViewDelegate;
    ...
    iget v6, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->pressedTranslationZ:F
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->shadowDrawable:Landroid/support/design/widget/ShadowDrawableWrapper;
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/ShadowDrawableWrapper;->setAddPaddingForCorners(Z)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->shadowDrawable:Landroid/support/design/widget/ShadowDrawableWrapper;
...
.method final setImageMatrixScale(F)V
    ...
    .line 284
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->tmpMatrix:Landroid/graphics/Matrix;

    .line 285
    invoke-direct {p0, p1, v1}, Landroid/support/design/widget/FloatingActionButtonImpl;->calculateImageMatrixFromScale(FLandroid/graphics/Matrix;)V

    .line 286
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->view:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v0, v1}, Landroid/support/design/widget/VisibilityAwareImageButton;->setImageMatrix(Landroid/graphics/Matrix;)V
...
.method show(Landroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;Z)V
    ...
    .line 458
    new-instance v0, Landroid/support/design/widget/FloatingActionButtonImpl$2;

    invoke-direct {v0, p0, p2, p1}, Landroid/support/design/widget/FloatingActionButtonImpl$2;-><init>(Landroid/support/design/widget/FloatingActionButtonImpl;ZLandroid/support/design/widget/FloatingActionButtonImpl$InternalVisibilityChangedListener;)V
...
.method final updatePadding()V
    ...
    .line 551
    iget-object v5, p0, Landroid/support/design/widget/FloatingActionButtonImpl;->tmpRect:Landroid/graphics/Rect;

    .line 552
    invoke-virtual {p0, v5}, Landroid/support/design/widget/FloatingActionButtonImpl;->getPadding(Landroid/graphics/Rect;)V

    .line 553
    invoke-virtual {p0, v5}, Landroid/support/design/widget/FloatingActionButtonImpl;->onPaddingUpdated(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Landroid/support/design/widget/ShadowViewDelegate;->setShadowPadding(IIII)V
