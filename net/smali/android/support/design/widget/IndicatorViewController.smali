...
.method private createCaptionOpacityAnimator(Landroid/widget/TextView;Z)Landroid/animation/ObjectAnimator;
    ...
    .line 308
    sget-object v0, Landroid/support/design/animation/AnimationUtils;->LINEAR_INTERPOLATOR:Landroid/animation/TimeInterpolator;
...
.method private updateCaptionViewsVisibility(IIZ)V
    ...
    .line 226
    new-instance v0, Landroid/support/design/widget/IndicatorViewController$1;
...
.method addIndicator(Landroid/widget/TextView;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/IndicatorViewController;->context:Landroid/content/Context;
    ...
    iget-object v1, p0, Landroid/support/design/widget/IndicatorViewController;->indicatorArea:Landroid/widget/LinearLayout;

    const/4 v2, -0x1

    const/4 v3, -0x2

    invoke-virtual {v0, v1, v2, v3}, Landroid/support/design/widget/TextInputLayout;->addView(Landroid/view/View;II)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/IndicatorViewController;->captionArea:Landroid/widget/FrameLayout;
    ...
    invoke-direct {v5, v0}, Landroid/support/v4/widget/Space;-><init>(Landroid/content/Context;)V
...
.method adjustIndicatorPadding()V
    ...
    invoke-static {v0, v1, v3, v2, v4}, Landroid/support/v4/view/ViewCompat;->setPaddingRelative(Landroid/view/View;IIII)V
...
.method setErrorEnabled(Z)V
    ...
    .line 427
    :cond_1
    iget v0, p0, Landroid/support/design/widget/IndicatorViewController;->errorTextAppearance:I

    invoke-virtual {p0, v0}, Landroid/support/design/widget/IndicatorViewController;->setErrorTextAppearance(I)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/design/widget/IndicatorViewController;->addIndicator(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/design/widget/IndicatorViewController;->removeIndicator(Landroid/widget/TextView;I)V
...
.method setHelperTextEnabled(Z)V
    ...
    .line 467
    iget v0, p0, Landroid/support/design/widget/IndicatorViewController;->helperTextTextAppearance:I

    invoke-virtual {p0, v0}, Landroid/support/design/widget/IndicatorViewController;->setHelperTextAppearance(I)V
