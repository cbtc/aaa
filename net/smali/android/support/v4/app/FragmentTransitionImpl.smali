...
.method protected static bfsAddViewChildren(Ljava/util/List;Landroid/view/View;)V
    ...
    .line 312
    invoke-static {p0, p1, v1}, Landroid/support/v4/app/FragmentTransitionImpl;->containedBeforeIndex(Ljava/util/List;Landroid/view/View;I)Z
    ...
    .line 323
    invoke-static {p0, v7, v1}, Landroid/support/v4/app/FragmentTransitionImpl;->containedBeforeIndex(Ljava/util/List;Landroid/view/View;I)Z
...
.method captureTransitioningViews(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    .line 192
    invoke-static {v1}, Landroid/support/v4/view/ViewGroupCompat;->isTransitionGroup(Landroid/view/ViewGroup;)Z
    ...
    .line 198
    invoke-virtual {p0, p1, v4}, Landroid/support/v4/app/FragmentTransitionImpl;->captureTransitioningViews(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method findNamedViews(Ljava/util/Map;Landroid/view/View;)V
    ...
    .line 222
    invoke-virtual {p0, p1, v5}, Landroid/support/v4/app/FragmentTransitionImpl;->findNamedViews(Ljava/util/Map;Landroid/view/View;)V
...
.method prepareSetNameOverridesReordered(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v4, v0}, Landroid/support/v4/view/ViewCompat;->setTransitionName(Landroid/view/View;Ljava/lang/String;)V
...
.method setNameOverridesReordered(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v10, v0}, Landroid/support/v4/view/ViewCompat;->setTransitionName(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-static {v0, v11}, Landroid/support/v4/view/ViewCompat;->setTransitionName(Landroid/view/View;Ljava/lang/String;)V
