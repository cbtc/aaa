...
.field final mEventToHandlers:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<Landroid/arch/lifecycle/Lifecycle$Event;Ljava/util/List<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;>;>;"
        }
    .end annotation
.end field
...
.field final mHandlerToEvent:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;Landroid/arch/lifecycle/Lifecycle$Event;>;"
        }
    .end annotation
.end field
...
.method constructor <init>(Ljava/util/Map;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/Map<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;Landroid/arch/lifecycle/Lifecycle$Event;>;)V"
        }
    .end annotation
...
.method private static invokeMethodsForEvent(Ljava/util/List;Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Lifecycle$Event;Ljava/lang/Object;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/List<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;>;Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Lifecycle$Event;Ljava/lang/Object;)V"
        }
    .end annotation
