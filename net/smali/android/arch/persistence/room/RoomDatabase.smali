...
.field public mCallbacks:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<Landroid/arch/persistence/room/RoomDatabase$Callback;>;"
        }
    .end annotation
.end field
...
.field public volatile mDatabase:Landroid/arch/persistence/db/SupportSQLiteDatabase;
...
.method public init(Landroid/arch/persistence/room/DatabaseConfiguration;)V
    ...
    .line 96
    iget-boolean v0, p1, Landroid/arch/persistence/room/DatabaseConfiguration;->allowMainThreadQueries:Z

    iput-boolean v0, p0, Landroid/arch/persistence/room/RoomDatabase;->mAllowMainThreadQueries:Z

    .line 97
    return-void
.end method

.method public internalInitInvalidationTracker(Landroid/arch/persistence/db/SupportSQLiteDatabase;)V
    .locals 1
...
.method public isOpen()Z
    ...
    .line 133
    iget-object v1, p0, Landroid/arch/persistence/room/RoomDatabase;->mDatabase:Landroid/arch/persistence/db/SupportSQLiteDatabase;

    .line 134
    if-eqz v1, :cond_0

    invoke-interface {v1}, Landroid/arch/persistence/db/SupportSQLiteDatabase;->isOpen()Z
