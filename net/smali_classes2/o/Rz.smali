...
# instance fields
.field protected final kit:Lo/Rt;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lo/Rz;->PROTOCOL_AND_HOST_PATTERN:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Lo/Rt;Ljava/lang/String;Ljava/lang/String;Lo/Sq;Lio/fabric/sdk/android/services/network/HttpMethod;)V
    ...
    .line 92
    :cond_1
    iput-object p1, p0, Lo/Rz;->kit:Lo/Rt;

    .line 93
    iput-object p2, p0, Lo/Rz;->protocolAndHostOverride:Ljava/lang/String;

    .line 94
    invoke-direct {p0, p3}, Lo/Rz;->overrideProtocolAndHost(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lo/Rz;->url:Ljava/lang/String;

    .line 95
    iput-object p4, p0, Lo/Rz;->requestFactory:Lo/Sq;

    .line 96
    iput-object p5, p0, Lo/Rz;->method:Lio/fabric/sdk/android/services/network/HttpMethod;
...
.method private overrideProtocolAndHost(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 157
    iget-object v0, p0, Lo/Rz;->protocolAndHostOverride:Ljava/lang/String;
    ...
    .line 158
    sget-object v0, Lo/Rz;->PROTOCOL_AND_HOST_PATTERN:Ljava/util/regex/Pattern;

    invoke-virtual {v0, p1}, Ljava/util/regex/Pattern;->matcher(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;

    move-result-object v0

    iget-object v1, p0, Lo/Rz;->protocolAndHostOverride:Ljava/lang/String;
...
.method protected getHttpRequest()Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {p0, v0}, Lo/Rz;->getHttpRequest(Ljava/util/Map;)Lio/fabric/sdk/android/services/network/HttpRequest;
...
.method protected getHttpRequest(Ljava/util/Map;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Lio/fabric/sdk/android/services/network/HttpRequest;"
        }
    .end annotation

    .line 137
    iget-object v0, p0, Lo/Rz;->requestFactory:Lo/Sq;

    iget-object v1, p0, Lo/Rz;->method:Lio/fabric/sdk/android/services/network/HttpMethod;

    .line 138
    invoke-virtual {p0}, Lo/Rz;->getUrl()Ljava/lang/String;

    move-result-object v2

    .line 137
    invoke-interface {v0, v1, v2, p1}, Lo/Sq;->ˎ(Lio/fabric/sdk/android/services/network/HttpMethod;Ljava/lang/String;Ljava/util/Map;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {v4, v0}, Lio/fabric/sdk/android/services/network/HttpRequest;->ˏ(Z)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    invoke-virtual {v0, v1}, Lio/fabric/sdk/android/services/network/HttpRequest;->ˏ(I)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    iget-object v3, p0, Lo/Rz;->kit:Lo/Rt;

    .line 141
    invoke-virtual {v3}, Lo/Rt;->getVersion()Ljava/lang/String;
...
.method protected getUrl()Ljava/lang/String;
    ...
    .line 100
    iget-object v0, p0, Lo/Rz;->url:Ljava/lang/String;
