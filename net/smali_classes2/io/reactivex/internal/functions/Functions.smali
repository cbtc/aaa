...
.field static final ALWAYS_FALSE:Lio/reactivex/functions/Predicate;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/functions/Predicate<Ljava/lang/Object;>;"
        }
    .end annotation
.end field
...
.field static final EMPTY_CONSUMER:Lio/reactivex/functions/Consumer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/functions/Consumer<Ljava/lang/Object;>;"
        }
    .end annotation
.end field
...
.field static final IDENTITY:Lio/reactivex/functions/Function;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/functions/Function<Ljava/lang/Object;Ljava/lang/Object;>;"
        }
    .end annotation
.end field
...
.field public static final REQUEST_MAX:Lio/reactivex/functions/Consumer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/functions/Consumer<Lorg/reactivestreams/Subscription;>;"
        }
    .end annotation
.end field
...
.method public static createArrayList(I)Ljava/util/concurrent/Callable;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:Ljava/lang/Object;>(I)Ljava/util/concurrent/Callable<Ljava/util/List<TT;>;>;"
        }
    .end annotation
...
.method public static emptyConsumer()Lio/reactivex/functions/Consumer;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:Ljava/lang/Object;>()Lio/reactivex/functions/Consumer<TT;>;"
        }
    .end annotation
...
.method public static identity()Lio/reactivex/functions/Function;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:Ljava/lang/Object;>()Lio/reactivex/functions/Function<TT;TT;>;"
        }
    .end annotation
...
.method public static justFunction(Ljava/lang/Object;)Lio/reactivex/functions/Function;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:Ljava/lang/Object;U:Ljava/lang/Object;>(TU;)Lio/reactivex/functions/Function<TT;TU;>;"
        }
    .end annotation
...
.method public static toFunction(Lio/reactivex/functions/BiFunction;)Lio/reactivex/functions/Function;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T1:Ljava/lang/Object;T2:Ljava/lang/Object;R:Ljava/lang/Object;>(Lio/reactivex/functions/BiFunction<-TT1;-TT2;+TR;>;)Lio/reactivex/functions/Function<[Ljava/lang/Object;TR;>;"
        }
    .end annotation
