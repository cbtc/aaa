...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "<T:Ljava/lang/Object;>Ljava/lang/Object;Lio/reactivex/SingleSource<TT;>;"
    }
.end annotation
...
.method public static create(Lio/reactivex/SingleOnSubscribe;)Lio/reactivex/Single;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:Ljava/lang/Object;>(Lio/reactivex/SingleOnSubscribe<TT;>;)Lio/reactivex/Single<TT;>;"
        }
    .end annotation
...
.method public static fromCallable(Ljava/util/concurrent/Callable;)Lio/reactivex/Single;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:Ljava/lang/Object;>(Ljava/util/concurrent/Callable<+TT;>;)Lio/reactivex/Single<TT;>;"
        }
    .end annotation
...
.method public static zip(Ljava/lang/Iterable;Lio/reactivex/functions/Function;)Lio/reactivex/Single;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:Ljava/lang/Object;R:Ljava/lang/Object;>(Ljava/lang/Iterable<+Lio/reactivex/SingleSource<+TT;>;>;Lio/reactivex/functions/Function<-[Ljava/lang/Object;+TR;>;)Lio/reactivex/Single<TR;>;"
        }
    .end annotation
...
.method public final observeOn(Lio/reactivex/Scheduler;)Lio/reactivex/Single;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lio/reactivex/Scheduler;)Lio/reactivex/Single<TT;>;"
        }
    .end annotation
...
.method public final onErrorReturn(Lio/reactivex/functions/Function;)Lio/reactivex/Single;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lio/reactivex/functions/Function<Ljava/lang/Throwable;+TT;>;)Lio/reactivex/Single<TT;>;"
        }
    .end annotation
...
.method public final subscribe(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;
    ...
    .line 3419
    invoke-virtual {p0, v1}, Lio/reactivex/Single;->subscribe(Lio/reactivex/SingleObserver;)V
