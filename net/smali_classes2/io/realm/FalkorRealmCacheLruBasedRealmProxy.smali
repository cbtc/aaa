...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    .line 77
    invoke-static {}, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->createExpectedObjectSchemaInfo()Lio/realm/internal/OsObjectSchemaInfo;

    move-result-object v0

    sput-object v0, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->expectedObjectSchemaInfo:Lio/realm/internal/OsObjectSchemaInfo;
...
.method public static copy(Lio/realm/Realm;Lo/ᒍ;ZLjava/util/Map;)Lo/ᒍ;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lio/realm/Realm;Lo/\u148d;ZLjava/util/Map<Lio/realm/RealmModel;Lio/realm/internal/RealmObjectProxy;>;)Lo/\u148d;"
        }
    .end annotation
    ...
    invoke-interface {v1}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$path()Ljava/lang/String;
    ...
    check-cast v6, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;

    .line 454
    move-object v7, v5

    check-cast v7, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;

    .line 456
    invoke-interface {v6}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$payload()Ljava/lang/String;

    move-result-object v0

    invoke-interface {v7, v0}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$payload(Ljava/lang/String;)V

    .line 457
    invoke-interface {v6}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$expiry()Ljava/util/Date;

    move-result-object v0

    invoke-interface {v7, v0}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$expiry(Ljava/util/Date;)V

    .line 458
    invoke-interface {v6}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$lastModified()J

    move-result-wide v0

    invoke-interface {v7, v0, v1}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$lastModified(J)V

    .line 459
    invoke-interface {v6}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$sentinel()Z

    move-result v0

    invoke-interface {v7, v0}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$sentinel(Z)V

    .line 460
    return-object v5
.end method

.method public static copyOrUpdate(Lio/realm/Realm;Lo/ᒍ;ZLjava/util/Map;)Lo/ᒍ;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lio/realm/Realm;Lo/\u148d;ZLjava/util/Map<Lio/realm/RealmModel;Lio/realm/internal/RealmObjectProxy;>;)Lo/\u148d;"
    ...
    check-cast v11, Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;

    .line 419
    iget-wide v12, v11, Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;->pathIndex:J
    ...
    .line 432
    new-instance v8, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;

    invoke-direct {v8}, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;-><init>()V
    ...
    invoke-static {v0, v8, v1, v2}, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->update(Lio/realm/Realm;Lo/ᒍ;Lo/ᒍ;Ljava/util/Map;)Lo/ᒍ;
    ...
    invoke-static {v0, v1, v2, v3}, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->copy(Lio/realm/Realm;Lo/ᒍ;ZLjava/util/Map;)Lo/ᒍ;
...
.method public static createColumnInfo(Lio/realm/internal/OsSchemaInfo;)Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;
    .locals 1

    .line 250
    new-instance v0, Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;

    invoke-direct {v0, p0}, Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;-><init>(Lio/realm/internal/OsSchemaInfo;)V
...
.method public static getExpectedObjectSchemaInfo()Lio/realm/internal/OsObjectSchemaInfo;
    ...
    .line 246
    sget-object v0, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->expectedObjectSchemaInfo:Lio/realm/internal/OsObjectSchemaInfo;
...
.method public static getTableName()Ljava/lang/String;
    ...
    .line 254
    const-string v0, "class_FalkorRealmCacheLruBased"

    return-object v0
.end method

.method static update(Lio/realm/Realm;Lo/ᒍ;Lo/ᒍ;Ljava/util/Map;)Lo/ᒍ;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lio/realm/Realm;Lo/\u148d;Lo/\u148d;Ljava/util/Map<Lio/realm/RealmModel;Lio/realm/internal/RealmObjectProxy;>;)Lo/\u148d;"
        }
    .end annotation
    ...
    .line 648
    invoke-interface {v3}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$payload()Ljava/lang/String;

    move-result-object v0

    invoke-interface {v2, v0}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$payload(Ljava/lang/String;)V

    .line 649
    invoke-interface {v3}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$expiry()Ljava/util/Date;

    move-result-object v0

    invoke-interface {v2, v0}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$expiry(Ljava/util/Date;)V

    .line 650
    invoke-interface {v3}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$lastModified()J

    move-result-wide v0

    invoke-interface {v2, v0, v1}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$lastModified(J)V

    .line 651
    invoke-interface {v3}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmGet$sentinel()Z

    move-result v0

    invoke-interface {v2, v0}, Lio/realm/FalkorRealmCacheLruBasedRealmProxyInterface;->realmSet$sentinel(Z)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v4, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;
    ...
    .line 710
    iget-object v0, v4, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->proxyState:Lio/realm/ProxyState;
    ...
    iget-object v2, v4, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->proxyState:Lio/realm/ProxyState;
...
.method public realm$injectObjectContext()V
    ...
    iput-object v0, p0, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->columnInfo:Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;
    ...
    iput-object v0, p0, Lio/realm/FalkorRealmCacheLruBasedRealmProxy;->proxyState:Lio/realm/ProxyState;
...
.method public realmGet$lastModified()J
    ...
    iget-wide v1, v1, Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;->lastModifiedIndex:J
...
.method public realmGet$path()Ljava/lang/String;
    ...
    iget-wide v1, v1, Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;->pathIndex:J
...
.method public realmGet$sentinel()Z
    ...
    iget-wide v1, v1, Lio/realm/FalkorRealmCacheLruBasedRealmProxy$FalkorRealmCacheLruBasedColumnInfo;->sentinelIndex:J
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "FalkorRealmCacheLruBased = proxy["
