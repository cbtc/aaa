...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, v8, v9, v10}, Landroid/support/design/bottomappbar/BottomAppBarTopEdgeTreatment;-><init>(FFF)V
    ...
    .line 156
    new-instance v11, Landroid/support/design/shape/ShapePathModel;

    invoke-direct {v11}, Landroid/support/design/shape/ShapePathModel;-><init>()V
    ...
    invoke-virtual {v11, v0}, Landroid/support/design/shape/ShapePathModel;->setTopEdge(Landroid/support/design/shape/EdgeTreatment;)V

    .line 158
    new-instance v0, Landroid/support/design/shape/MaterialShapeDrawable;

    invoke-direct {v0, v11}, Landroid/support/design/shape/MaterialShapeDrawable;-><init>(Landroid/support/design/shape/ShapePathModel;)V
    ...
    invoke-static {v0, v7}, Landroid/support/v4/graphics/drawable/DrawableCompat;->setTintList(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
...
.method private createCradleShapeAnimation(ZLjava/util/List;)V
    ...
    .line 479
    invoke-virtual {v1}, Landroid/support/design/shape/MaterialShapeDrawable;->getInterpolation()F
...
.method private createCradleTranslationAnimation(ILjava/util/List;)V
    ...
    .line 322
    invoke-virtual {v1}, Landroid/support/design/bottomappbar/BottomAppBarTopEdgeTreatment;->getHorizontalOffset()F
...
.method private createMenuViewTranslationAnimation(IZLjava/util/List;)V
    ...
    .line 417
    new-instance v0, Landroid/support/design/bottomappbar/BottomAppBar$4;

    invoke-direct {v0, p0, v2, p1, p2}, Landroid/support/design/bottomappbar/BottomAppBar$4;-><init>(Landroid/support/design/bottomappbar/BottomAppBar;Landroid/support/v7/widget/ActionMenuView;IZ)V
...
.method private findDependentFab()Landroid/support/design/widget/FloatingActionButton;
    ...
    .line 345
    instance-of v0, v3, Landroid/support/design/widget/FloatingActionButton;
...
.method private getActionMenuView()Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 546
    instance-of v0, v2, Landroid/support/v7/widget/ActionMenuView;
...
.method private isVisibleFab()Z
    ...
    invoke-virtual {v1}, Landroid/support/design/widget/FloatingActionButton;->isOrWillBeShown()Z
...
.method private maybeAnimateAttachChange(Z)V
    ...
    :goto_0
    invoke-direct {p0, v0, v2}, Landroid/support/design/bottomappbar/BottomAppBar;->createCradleShapeAnimation(ZLjava/util/List;)V

    .line 457
    invoke-direct {p0, p1, v2}, Landroid/support/design/bottomappbar/BottomAppBar;->createFabTranslationYAnimation(ZLjava/util/List;)V
    ...
    .line 461
    iput-object v3, p0, Landroid/support/design/bottomappbar/BottomAppBar;->attachAnimator:Landroid/animation/Animator;
...
.method private maybeAnimateMenuView(IZ)V
    ...
    .line 383
    :cond_2
    invoke-direct {p0, p1, p2, v2}, Landroid/support/design/bottomappbar/BottomAppBar;->createMenuViewTranslationAnimation(IZLjava/util/List;)V
    ...
    .line 387
    iput-object v3, p0, Landroid/support/design/bottomappbar/BottomAppBar;->menuAnimator:Landroid/animation/Animator;
...
.method private maybeAnimateModeChange(I)V
    ...
    .line 298
    invoke-direct {p0, p1, v2}, Landroid/support/design/bottomappbar/BottomAppBar;->createCradleTranslationAnimation(ILjava/util/List;)V

    .line 299
    invoke-direct {p0, p1, v2}, Landroid/support/design/bottomappbar/BottomAppBar;->createFabTranslationXAnimation(ILjava/util/List;)V
    ...
    .line 303
    iput-object v3, p0, Landroid/support/design/bottomappbar/BottomAppBar;->modeAnimator:Landroid/animation/Animator;
...
.method private setCutoutState()V
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ActionMenuView;->setAlpha(F)V
    ...
    invoke-direct {p0, v3, v0, v1}, Landroid/support/design/bottomappbar/BottomAppBar;->translateActionMenuView(Landroid/support/v7/widget/ActionMenuView;IZ)V
...
.method public getBehavior()Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()Landroid/support/design/widget/CoordinatorLayout$Behavior<Landroid/support/design/bottomappbar/BottomAppBar;>;"
        }
    .end annotation
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    check-cast v1, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;

    .line 800
    invoke-virtual {v1}, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->getSuperState()Landroid/os/Parcelable;
    ...
    .line 801
    iget v0, v1, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->fabAlignmentMode:I

    iput v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->fabAlignmentMode:I

    .line 802
    iget-boolean v0, v1, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->fabAttached:Z
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 787
    new-instance v2, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;

    invoke-direct {v2, v1}, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;-><init>(Landroid/os/Parcelable;)V

    .line 788
    iget v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->fabAlignmentMode:I

    iput v0, v2, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->fabAlignmentMode:I

    .line 789
    iget-boolean v0, p0, Landroid/support/design/bottomappbar/BottomAppBar;->fabAttached:Z

    iput-boolean v0, v2, Landroid/support/design/bottomappbar/BottomAppBar$SavedState;->fabAttached:Z
