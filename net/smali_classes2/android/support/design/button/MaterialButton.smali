...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 147
    sget v0, Landroid/support/design/R$styleable;->MaterialButton_iconPadding:I
    ...
    iput v0, p0, Landroid/support/design/button/MaterialButton;->iconPadding:I

    .line 148
    sget v0, Landroid/support/design/R$styleable;->MaterialButton_iconTintMode:I
    ...
    iput-object v0, p0, Landroid/support/design/button/MaterialButton;->iconTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    sget v1, Landroid/support/design/R$styleable;->MaterialButton_iconTint:I

    .line 153
    invoke-static {v0, v6, v1}, Landroid/support/design/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/button/MaterialButton;->iconTint:Landroid/content/res/ColorStateList;
    ...
    sget v1, Landroid/support/design/R$styleable;->MaterialButton_icon:I

    invoke-static {v0, v6, v1}, Landroid/support/design/resources/MaterialResources;->getDrawable(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 156
    sget v0, Landroid/support/design/R$styleable;->MaterialButton_iconGravity:I
    ...
    iput v0, p0, Landroid/support/design/button/MaterialButton;->iconGravity:I

    .line 158
    sget v0, Landroid/support/design/R$styleable;->MaterialButton_iconSize:I
    ...
    iput v0, p0, Landroid/support/design/button/MaterialButton;->iconSize:I

    .line 161
    new-instance v0, Landroid/support/design/button/MaterialButtonHelper;

    invoke-direct {v0, p0}, Landroid/support/design/button/MaterialButtonHelper;-><init>(Landroid/support/design/button/MaterialButton;)V

    iput-object v0, p0, Landroid/support/design/button/MaterialButton;->materialButtonHelper:Landroid/support/design/button/MaterialButtonHelper;
    ...
    invoke-virtual {v0, v6}, Landroid/support/design/button/MaterialButtonHelper;->loadFromAttributes(Landroid/content/res/TypedArray;)V
...
.method private updateIcon()V
    ...
    iget v4, p0, Landroid/support/design/button/MaterialButton;->iconSize:I
    ...
    iget v5, p0, Landroid/support/design/button/MaterialButton;->iconSize:I
    ...
    iget v2, p0, Landroid/support/design/button/MaterialButton;->iconLeft:I
    ...
    invoke-static {p0, v0, v1, v2, v3}, Landroid/support/v4/widget/TextViewCompat;->setCompoundDrawablesRelative(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method protected onMeasure(II)V
    ...
    .line 351
    :cond_3
    iget v0, p0, Landroid/support/design/button/MaterialButton;->iconLeft:I

    if-eq v0, v5, :cond_4

    .line 352
    iput v5, p0, Landroid/support/design/button/MaterialButton;->iconLeft:I
...
.method public setBackgroundResource(I)V
    ...
    .line 298
    :cond_0
    invoke-virtual {p0, v1}, Landroid/support/design/button/MaterialButton;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setIconResource(I)V
    ...
    .line 458
    :cond_0
    invoke-virtual {p0, v1}, Landroid/support/design/button/MaterialButton;->setIcon(Landroid/graphics/drawable/Drawable;)V
