...
.field public resolutions:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<Lorg/linphone/mediastream/video/capture/hwconf/AndroidCameraConfiguration$AndroidCamera$Size;>;"
        }
    .end annotation
.end field
...
.method public constructor <init>(IZILjava/util/List;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IZILjava/util/List<Landroid/hardware/Camera$Size;>;)V"
        }
    .end annotation
    ...
    .line 114
    iget-object v0, p0, Lorg/linphone/mediastream/video/capture/hwconf/AndroidCameraConfiguration$AndroidCamera;->resolutions:Ljava/util/List;

    new-instance v1, Lorg/linphone/mediastream/video/capture/hwconf/AndroidCameraConfiguration$AndroidCamera$Size;

    iget v2, v5, Landroid/hardware/Camera$Size;->width:I

    iget v3, v5, Landroid/hardware/Camera$Size;->height:I

    invoke-direct {v1, v2, v3}, Lorg/linphone/mediastream/video/capture/hwconf/AndroidCameraConfiguration$AndroidCamera$Size;-><init>(II)V
...
.method public constructor <init>(IZLjava/util/List;I)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IZLjava/util/List<Lorg/linphone/mediastream/video/capture/hwconf/AndroidCameraConfiguration$AndroidCamera$Size;>;I)V"
        }
    .end annotation
